...
struct WellSpentDependencies: Sendable {
    ...
    static let live = WellSpentDependencies(
        nowProvider: .live,
        localeProvider: .live,
...
private struct WellSpentDependenciesKey: EnvironmentKey {
    static let defaultValue = WellSpentDependencies.live
}

extension EnvironmentValues {
    var wellSpentDependencies: WellSpentDependencies {
        get { self[WellSpentDependenciesKey.self] }
        set { self[WellSpentDependenciesKey.self] = newValue }
    }
}
