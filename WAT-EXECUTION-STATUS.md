...
| WAT-27 | In Progress; build-4-bound five-screen 416×496 draft passed visual review; exact exported phone/Watch icon catalogs pass binary integrity; clean local site commit `3a9b9cb` passes Watch-aware copy/link validation but is not published | Publish after action-time confirmation; visually review live pages, processed icon and final build-4 candidate screenshots; see WAT-27-STORE-MATERIALS-DRAFT.md |
