...
| WAT-24 | In Progress; 31-case/55-record manifest and validator pass; aligned 0.1.0 (2) install, physical data reset and a live foreground Start/Pause/Resume/End/history diagnostic are verified, with zero matrix rows promoted; September 4 preflight 10 is ready | Execute frozen debugger-detached rows while the pair remains nearby/unlocked; reinstall/unpair/upgrade/replacement retain separate authorization gates; see WAT-24-PAIRED-DEVICE-MATRIX.md |
...
| WAT-26 | In Progress; App Store Connect confirms build 3 is unused for 0.1.0 and the working source carries approved identity 0.1.0 (3); exact dSYM/signature checks pass on the earlier build-2 clean-source development archive, its native aggregate privacy report is reconciled, and CI enforces generated-project parity plus provenance | Create the clean build-3 source checkpoint, run candidate-bound CI, then produce and validate the distribution archive/privacy report/upload; see WAT-26-ARCHIVE-VALIDATION.md |
| WAT-27 | In Progress; five-screen 416×496 preferred-size Simulator draft plus sanitized 410×502 physical Ultra composition proof, opaque 44/60/80px icon legibility samples, and paired support/privacy/accessibility/beta/App Store copy are reviewed and guarded locally | Exact-candidate App Store-size assets and processed icon, measured retention wording, public-page review and App Store warnings; see WAT-27-STORE-MATERIALS-DRAFT.md |
| WAT-28 | In Progress; beta/triage/manual-release/containment runbook and paired beta package integrated and copy-guarded locally | Actual processed beta, testers, review, authorized release and production smoke; see WAT-28-BETA-RELEASE-RUNBOOK.md |
