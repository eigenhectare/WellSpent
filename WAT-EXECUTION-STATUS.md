...
| WAT-28 | In Progress; identifier-free build-4 beta package binds pushed source/CI/archive/distribution export/upload/processing; no testers or external cohort were used | Complete authorized review/manual release and public-binary smoke; see WAT-28-BETA-RELEASE-RUNBOOK.md |
