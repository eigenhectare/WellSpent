...
| WAT-28 | In Progress; identifier-free build-4 beta package binds pushed source/CI/archive; no testers or external cohort were used | Upload/process exact build 4, complete authorized review/manual release and public-binary smoke; see WAT-28-BETA-RELEASE-RUNBOOK.md |
