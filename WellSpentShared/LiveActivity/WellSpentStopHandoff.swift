...
public struct WellSpentStopRequest: Codable, Equatable, Sendable {
...
public enum WellSpentStopHandoffError: LocalizedError, Equatable {
...
public enum WellSpentStopHandoff {
    ...
    private static func request(at fileURL: URL) throws -> WellSpentStopRequest? {
        do {
            return try JSONDecoder().decode(
                WellSpentStopRequest.self,
    ...
    private static func storageDirectory(for suiteName: String) throws -> URL {
        if suiteName == appGroupIdentifier {
            guard
                ...
                throw WellSpentStopHandoffError.suiteUnavailable
            }
            return
                containerURL
                .appendingPathComponent("Library/Application Support", isDirectory: true)
                .appendingPathComponent("WellSpent", isDirectory: true)
        ...
        return FileManager.default.temporaryDirectory
            .appendingPathComponent("WellSpentStopHandoffTests", isDirectory: true)
