...
@MainActor
final class BillableHoursAppModel: ObservableObject {
    ...
    init(
        ...
        stopHandoffSuiteName: String = BillableHoursStopHandoff.appGroupIdentifier,
    ...
    func handle(url: URL) async {
        guard let sessionID = BillableHoursDeepLink.completionActivityID(from: url) else {
